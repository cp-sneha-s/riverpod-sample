...
abstract class $EmployeeCopyWith<$Res> {
  ...
  $Res call(
      ...
      String email,
      String address,
      @TimeStampJsonConverter() DateTime joiningDate});
}
...
class _$EmployeeImpl implements _Employee {
  const _$EmployeeImpl(
      ...
      @TimeStampJsonConverter() required this.joiningDate});
  ...
  @override
  String toString() {
    return 'Employee(id: $id, name: $name, phone: $phone, email: $email, address: $address, joiningDate: $joiningDate)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, phone, email, address, joiningDate);
...
abstract class _Employee implements Employee {
  const factory _Employee(
          ...
          @TimeStampJsonConverter() required final DateTime joiningDate}) =
      _$EmployeeImpl;
